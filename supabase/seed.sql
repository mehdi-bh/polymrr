...
insert into markets (id, startup_slug, type, question, resolution_criteria, resolution_config, created_by, status, yes_odds, yes_shares, no_shares, liquidity_param, total_credits, total_bettors, created_at, closes_at, resolved_at, resolved_outcome) values
  ('a0000000-0000-0000-0000-000000000001', 'shipfast',     'mrr-target',  'Will ShipFast reach $50k MRR?',            'Resolves YES if ShipFast''s MRR reach or exceed $50k by close date. Data from TrustMRR.',         '{"metric":"mrr","condition":"gte","target":5000000,"dbColumn":"revenue_mrr"}',   null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-15', '2026-06-30', null, null),
  ('a0000000-0000-0000-0000-000000000002', 'chatbase',     'mrr-target',  'Will Chatbase reach $100k MRR?',           'Resolves YES if Chatbase''s MRR reach or exceed $100k by close date. Data from TrustMRR.',        '{"metric":"mrr","condition":"gte","target":10000000,"dbColumn":"revenue_mrr"}',  null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-01', '2026-04-30', null, null),
  ('a0000000-0000-0000-0000-000000000003', 'pulsetic',     'acquisition', 'Will Pulsetic be listed for sale?',        'Resolves YES if Pulsetic''s Listed for Sale be yes by close date. Data from TrustMRR.',           '{"metric":"on_sale","condition":"eq","target":1,"dbColumn":"on_sale"}',          null, 'open', 50, 0, 0, 1500, 0, 0, '2026-02-01', '2026-07-01', null, null),
  ('a0000000-0000-0000-0000-000000000004', 'typingmind',   'growth-race', 'Will TypingMind reach 20% 30d Growth?',    'Resolves YES if TypingMind''s 30d Growth reach or exceed 20% by close date. Data from TrustMRR.', '{"metric":"growth_30d","condition":"gte","target":0.2,"dbColumn":"growth_30d"}', null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-01', '2026-04-01', null, null),
  ('a0000000-0000-0000-0000-000000000005', 'draftql',      'survival',    'Will DraftQL maintain above $1.2k MRR?',   'Resolves YES if DraftQL''s MRR reach or exceed $1.2k by close date. Data from TrustMRR.',         '{"metric":"mrr","condition":"gte","target":120000,"dbColumn":"revenue_mrr"}',    null, 'open', 50, 0, 0, 1500, 0, 0, '2026-02-15', '2026-12-31', null, null),
  ('a0000000-0000-0000-0000-000000000006', 'podsqueeze',   'mrr-target',  'Will PodSqueeze reach $15k MRR?',          'Resolves YES if PodSqueeze''s MRR reach or exceed $15k by close date. Data from TrustMRR.',       '{"metric":"mrr","condition":"gte","target":1500000,"dbColumn":"revenue_mrr"}',   null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-20', '2026-05-31', null, null),
  ('a0000000-0000-0000-0000-000000000007', 'screenshotai', 'mrr-target',  'Will ScreenshotAI reach $5k MRR?',         'Resolves YES if ScreenshotAI''s MRR reach or exceed $5k by close date. Data from TrustMRR.',      '{"metric":"mrr","condition":"gte","target":500000,"dbColumn":"revenue_mrr"}',    null, 'open', 50, 0, 0, 1500, 0, 0, '2026-02-01', '2026-08-31', null, null),
  ('a0000000-0000-0000-0000-000000000008', 'analyzee',     'growth-race', 'Will Analyzee reach $8k MRR?',             'Resolves YES if Analyzee''s MRR reach or exceed $8k by close date. Data from TrustMRR.',          '{"metric":"mrr","condition":"gte","target":800000,"dbColumn":"revenue_mrr"}',    null, 'open', 50, 0, 0, 1500, 0, 0, '2026-03-01', '2026-12-31', null, null),
  ('a0000000-0000-0000-0000-000000000009', 'notionforms',  'mrr-target',  'Will NotionForms reach $10k MRR?',         'Resolves YES if NotionForms''s MRR reach or exceed $10k by close date. Data from TrustMRR.',      '{"metric":"mrr","condition":"gte","target":1000000,"dbColumn":"revenue_mrr"}',   null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-10', '2026-09-30', null, null),
  ('a0000000-0000-0000-0000-000000000010', 'churnkey',     'mrr-target',  'Will Churnkey reach $35k MRR?',            'Resolves YES if Churnkey''s MRR reach or exceed $35k by close date. Data from TrustMRR.',         '{"metric":"mrr","condition":"gte","target":3500000,"dbColumn":"revenue_mrr"}',   null, 'open', 50, 0, 0, 1500, 0, 0, '2026-01-05', '2026-05-31', null, null);
